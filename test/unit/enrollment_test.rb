...
class EnrollmentTest < ActiveSupport::TestCase
  ...
  context "ActiveRecord" do
    ...
    context "validations" do
      ...
      should validate_uniqueness_of(:boat_id).scoped_to(:registration_role_id)
    end
  ...
  context "Lifecycle" do
	...
	@rr = Factory :registration_role
        ...
        enrollment_params = {:registration_role=>@rr, :boat=>@boat, :crew=>@crew, :country=>@country}
	...
	assert_equal @rr, @enrollment.registration_role
